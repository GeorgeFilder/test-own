...
window.addEventListener('load', async () => {
    if (isMobile() && typeof window?.ethereum === 'undefined') {
        ...
        document.querySelector("#wltConnectButton").addEventListener("click", async () => {
            connectWalletConnect()
        });
    } else {
        document.querySelector("#connectButton").addEventListener("click", connectButton);
        document.querySelector("#wltConnectButton").addEventListener("click", connectWalletConnect);
    }
});
